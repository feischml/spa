...
function initialize() {
    updateTimerDisplay(), updateProgressBar(), clearInterval(time_update_interval), time_update_interval = setInterval(function() {
        updateTimerDisplay(), updateProgressBar()
    }, 1e3), $("#volume-input").val(Math.round(player.getVolume()))
}
...
$(function() {
    $("#progress-bar").on("mouseup touchend", function(e) {
        ...
        var e = $(this);
        player.isMuted() ? (player.unMute(), e.text("volume_up")) : (player.mute(), e.text("volume_off"))
